...
SP=${1:?Error: Please provide a value at the end of the script. 1 for SP, 0 for no SP}
GBS=4
...
RUN_ID=${TS}___gpt-22B-${NUM_NODES}x${GPUS_PER_NODE}_tp${TP}${sptag}_gbs${GBS}_len2048-profile
